...
hook.Add("HUDPaint", "DrawFalconHUD", function()
    ...
    surface.DrawCurvedRect( w * 0.171, h * 0.78, w * 0.0275, w * 0.0325, 120, Color( 18, 18, 18, 255 ) )

    surface.DrawCurvedRect( w * 0.18, h * 0.84, w * 0.03, w * 0.035, 90, Color( 255, 255, 255, 255 ) )
    surface.DrawCurvedRect( w * 0.18, h * 0.84, w * 0.0275, w * 0.0325, 90, Color( 18, 18, 18, 255 ) )

    surface.DrawCurvedRect( w * 0.171, h * 0.9, w * 0.03, w * 0.035, 60, Color( 255, 255, 255, 255 ) )
    surface.DrawCurvedRect( w * 0.171, h * 0.9, w * 0.0275, w * 0.0325, 60, Color( 18, 18, 18, 255 ) )
